...
if (isset($_POST['workshop'])) {
    ...
    if (isset($_POST['button1'])){
        ...
        $query = "INSERT INTO `Ответственные за испытания на АЭС` VALUES(NULL, NULL, NULL ,'$workshop', NULL ,NULL , NULL, NULL,NULL)";
...
<body>
	...
	<h2 class = "title">Добавить цех</h2>
...
<section class = "main">
    ...
    <p>Введите наименование цеха:
    <input type="text" value="<?php echo isset($_SESSION['workshop']) ? $_SESSION['workshop'] : ''; ?>" name="workshop" /> </p>
