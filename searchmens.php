...
<html>
<head>
<title>Поиск испытателей по должности</title>
<meta charset="utf-8">
...
<body>
	...
	<h2 class = "title">Поиск по должности</h2>
...
require_once 'connection.php'; // подключаем скрипт
    ...
    ?>
<form method="POST">
<p>Введите должность испытателя:<br> 
<?php
$db = mysqli_connect($host, $user, $password);
mysqli_select_db($db, $database);
if ($query5 = mysqli_query($db, "SELECT DISTINCT `post` FROM `Испытатели` ORDER BY `post`")){
