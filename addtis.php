...
if (isset($_POST['type_information_si'])) {
    ...
    if (isset($_POST['button1'])){
        ...
        $query = "INSERT INTO `Средства измерения` VALUES(NULL, NULL, NULL, NULL ,NULL, NULL , NULL, NULL, NULL,NULL,NULL,'$type_information_si',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL)";
...
<body>
	...
	<h2 class = "title">Добавить сведения</h2>
...
<section class = "main">
    ...
    <p>Введите сведение о типе СИ:
    <input type="text" value="<?php echo isset($_SESSION['type_information_si']) ? $_SESSION['type_information_si'] : ''; ?>" name="type_information_si" /> </p>
