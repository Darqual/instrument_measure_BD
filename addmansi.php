...
if (isset($_POST['title_company'])) {
    ...
    if (isset($_POST['button1'])){
        ...
        $query = "INSERT INTO `Изготовители СИ` VALUES(NULL, '$title_company','$data_registration' ,'$physical_address', '$legal_address' ,'$license' , '$email_manufacturers')";
...
<section class = "main">
    ...
    <p>Введите наименования производителя эталонного оборудования (пример: ОАО "Горный"):
    ...
    <p>Введите физический адрес (пример: г. Новосибирск, Ленинградский просект, д.1, 1 этаж.):
    <input type="text" value="<?php echo isset($_SESSION['physical_address']) ? $_SESSION['physical_address'] : ''; ?>" name="physical_address" /> </p>
    
    <p>Введите юридический адрес (пример: г. Новосибирск, Ленинградский просект, д.1, 1 этаж.):    
    ...
    <p>Введите электронную почту (пример: machinestroyhelp@mail.ru):    
