...
if (isset($_POST['post'])) {
    ...
    if (isset($_POST['button1'])){
        ...
        $query = "INSERT INTO `Ответственные за испытания на АЭС` VALUES(NULL, NULL, NULL ,NULL, NULL ,NULL , NULL, '$post', NULL)";
...
<body>
	...
	<h2 class = "title">Добавить должность</h2>
...
<section class = "main">
    ...
    <p>Введите должность:
    <input type="text" value="<?php echo isset($_SESSION['post']) ? $_SESSION['post'] : ''; ?>" name="post" /> </p>
