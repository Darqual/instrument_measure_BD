...
if (isset($_POST['power_unit_numbers'])) {
    ...
    if (isset($_POST['button1'])){
        ...
        $query = "INSERT INTO `Средства измерения` VALUES(NULL, NULL, NULL ,NULL, NULL ,'$power_unit_numbers' , NULL, NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL)";
...
<body>
	...
	<h2 class = "title">Добавить энергоблок</h2>
...
<section class = "main">
    ...
    <p>Введите номер энергоблока:
    <input type="text" value="<?php echo isset($_SESSION['power_unit_numbers']) ? $_SESSION['power_unit_numbers'] : ''; ?>" name="power_unit_numbers" /> </p>
