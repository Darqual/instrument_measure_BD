...
if (isset($_POST['title'])) {
    ...
    if (isset($_POST['button1'])){
        ...
        $query = "INSERT INTO `Наименования СИ` VALUES('$title')";
...
<body>
	...
	<h2 class = "title">Добавить наименование СИ</h2>
...
<section class = "main">
    ...
    <p>Введите наименование СИ:
    <input type="text" value="<?php echo isset($_SESSION['title']) ? $_SESSION['title'] : ''; ?>" name="title" /> </p>
