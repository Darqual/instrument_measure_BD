...
if (isset($_POST['principle_operation'])) {
    ...
    if (isset($_POST['button1'])){
        ...
        $query = "INSERT INTO `Средства измерения` VALUES(NULL, NULL, NULL, NULL ,NULL, NULL ,NULL , NULL, NULL,NULL,NULL,NULL,NULL,NULL,'$principle_operation' ,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL)";
...
<body>
	...
	<h2 class = "title">Добавить принцип действия</h2>
...
<section class = "main">
    ...
    <p>Введите принцип действия:
    <input type="text" value="<?php echo isset($_SESSION['principle_operation']) ? $_SESSION['principle_operation'] : ''; ?>" name="principle_operation" /> </p>
