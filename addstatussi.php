...
if (isset($_POST['status'])) {
    ...
    if (isset($_POST['button1'])){
        ...
        $query = "INSERT INTO `Средства измерения` VALUES(NULL, NULL, NULL, NULL, NULL, NULL ,NULL , NULL, NULL,NULL,NULL,NULL,'$status',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL)";
...
<body>
	...
	<h2 class = "title">Добавить статус</h2>
...
<section class = "main">
    ...
    <p>Введите новый статус:
    <input type="text" value="<?php echo isset($_SESSION['status']) ? $_SESSION['status'] : ''; ?>" name="status" /> </p>
